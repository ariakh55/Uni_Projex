  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar ftco-navbar-light site-navbar-target" id="ftco-navbar">
	    <div class="container">
	      ...
	      <a href="/poemOnline/index.php#page-1"><button class="btn" type="button">
	        بازگشت
          </button></a>
	    </div>
      </nav>
					...
					<div class="row justify-content-start text-center pb-3">
						<div class="col-md-12 heading-section ftco-animate">
							...
							<div class="text-about justify-content-start">
                                ...
                                <p><?php 
                                    $sep = '\r\n';
                                    $line = strtok($poem,$sep);
                                    while ($line !== false){
                                        $line_sep = strpos($line,".");
                                        echo substr($line,0,$line_sep)."&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;".substr($line,$line_sep+1)."<br>";
                                        $line = strtok( $sep );
                                    }
                                ?></p>
							</div>
