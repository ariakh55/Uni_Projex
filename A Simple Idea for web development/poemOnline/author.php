...
<head>
    <title><?php
        $id = $_GET['id'];
        $res = mysqli_query($conn, $authorsql);
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar ftco-navbar-light site-navbar-target" id="ftco-navbar">
	    <div class="container">
	      ...
	      <a href="/poemOnline/index.php#author-section"><button class="btn" type="button">
	        بازگشت
          </button></a>
	    </div>
      </nav>
				...
				<div class="col-md-12 col-lg-12 pl-md-5">
					<div class="row justify-content-start text-right pb-3">
						<div class="col-md-12 heading-section ftco-animate">
							<h2 class="mb-4" style="font-family: Tanha FD;"><?php echo $name?></h2>
							<div class="text-about justify-content-start">
                                <img class="circleAvatar" src="<?php echo $img?>" />
                                <h4 style="font-family: Vazir FD">سن: <?php echo $age?></h4>
                                <p><?php echo $about?></p>
							</div>
						</div>
					</div>
